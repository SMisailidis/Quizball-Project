...
const UploadQuestions = (props: propsType) => {
  ...
  const [success, setSuccess] = useState<"primary" | "success" | "error">(
    "primary"
  );
  ...
  const handleSubmitQuestion = () => {
    ...
    if (
      noTonalsAnswer !== noTonalsFifty[0] &&
      noTonalsAnswer !== noTonalsFifty[1]
    ) {
  ...
  const postObj = (obj: QuestionsType) => {
    fetch(
      `https://quizball-project-default-rtdb.europe-west1.firebasedatabase.app/categories/${categorySelect}/questions.json`,
      {
        method: "POST",
  ...
  return (
    <div className={[height.bodyFix, height.minHeight].join(" ")}>
      ...
      <div className={styles.outerContainer}>
        ...
        >
          <InputLabel id="demo-simple-select-label" error={!isCorrectCategory}>
            Διάλεξε μία κατηγορία
          </InputLabel>
          <Select
        ...
        <div className={styles.textFieldsContainer}>
          ...
          >
            <InputLabel id="demo-simple-select-label">
              Δώσε την δυσκολία της ερώτησης
            </InputLabel>
            <Select
              labelId="demo-simple-select-label"
              id="demo-simple-select"
        ...
        <div>
          <Button
            ...
            sx={[
              ...
              { "&:hover": { backgroundColor: "#2e6a92" } },
            ]}
            onClick={handleSubmitQuestion}
          >
            Καταχωρησε την ερωτηση
          </Button>
        </div>
      </div>
    </div>
